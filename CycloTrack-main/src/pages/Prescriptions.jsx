...
import { Plus, FileText, User, Calendar, Trash2, Eye, X } from 'lucide-react';
...
function FilePreviewModal({ url, onClose }) {
  ...
  return (
      ...
      >
        <div
            className="relative bg-background rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col"
            onClick={e => e.stopPropagation()}
        >
          <div className="flex items-center justify-between p-4 border-b border-border">
            <p className="text-sm font-medium text-foreground">Перегляд файлу</p>
